...
{
    [Export(typeof(IGame))]
    public class FallingRocks : GameBase, IGame
    {
        public string Name => "Falling Rocks";

        public string Description => "Move out of the way of the falling rocks.";
        ...
        {
            FallingRocksSolo.KeepGoing = false;
            Console.Clear();
            base.UnLoad();
        }
    }
    ...
    /// <summary>
    /// http://dobromirivanov.net/c-csharp-falling-rocks-console-game/
    /// </summary>
    /// 
    internal class FallingRocksSolo
    {
        public static bool KeepGoing { get; set; }
